...
There currently are about **15952** unique aircraft in **53** categories found in this repository. This [Dashboard](https://lookerstudio.google.com/reporting/94a654de-8cb5-4e7a-a3e5-e4ce25e47f37) contains details of the main list.
These aircraft are divided into four main databases:

-   [plane-alert-db.csv](plane-alert-db.csv) - A list of interesting aircraft with tags, categories and links. (15952)
-   [plane-alert-pia.csv](plane-alert-pia.csv): A list that contains PIA planes. (94)
-   [plane_images.csv](plane_images.csv): A accompanying list that contains aircraft images. (12192)
...
-   [plane-alert-mil.csv](plane-alert-mil.csv) - Military Only. (8739)
-   [plane-alert-pol.csv](plane-alert-pol.csv) - Police Forces. (933)
...
|Coastguard|Coastguard, Customs and Border Patrols|449|
...
|Police Forces|Your friendly neighbourhood flying (insert local colloquialism here).|915|
...
|Toy Soldiers|Armies from around the world.|1074|
...
|USAF|Aircraft of the United States Air Force|2452|
